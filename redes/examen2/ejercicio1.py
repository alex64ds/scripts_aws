...
if __name__ == "__main__":
    # --- Crear VPCs ---
    vpc_east = crear_vpc(REGION_EAST, '15.0.0.0/20', 'NUBEALEXvir1')

    # --- IGWs ---
    igw1_east = crear_igw_y_asociar(vpc_east, REGION_EAST, 'vir-alex1')


    # --- Subredes públicas y privadas ---
    sub_east = crear_subred_publica(vpc_east, REGION_EAST, '15.0.1.0/24','sub_vir', 'us-east-1a')
    sub1_priv_east = crear_subred_privada(vpc_east, REGION_EAST, '15.0.2.0/24', 'sub1_vir_priv','us-east-1b')
    sub2_priv_east = crear_subred_privada(vpc_east, REGION_EAST, '15.0.3.0/24', 'sub2_vir_priv','us-east-1c')
   

    # --- Tablas de rutas públicas ---
    rtb1_east = crear_route_table_publica(vpc_east, REGION_EAST, igw1_east, sub_east,'rtb_pub1')

    # --- Security Groups ---
    sg_east = crear_security_group(vpc_east, REGION_EAST, 'sg_vir1')

    sg_eastpriv = crear_security_group(vpc_east, REGION_EAST, 'sg_vir1priv')


    # --- Instancias EC2 ---
    lanzar_ec2vir(sub_east, sg_east, REGION_EAST,'EC2_vir1')
    lanzar_ec2_priv_vir(sub1_priv_east, sg_eastpriv, REGION_EAST,'EC2_vir1priv')
    lanzar_ec2_priv_vir(sub2_priv_east, sg_eastpriv, REGION_EAST,'EC2_vir2priv')


    # --- Nat Gateways ---
    nat_east = crear_nat_gateway(sub_east, REGION_EAST, 'nat_vir1')

    # --- Tablas de rutas Privadas ---

    rtb_priv1_east = crear_route_table_privada(vpc_east, REGION_EAST, nat_east, sub1_priv_east, 'rtb_priv_vir1')

    rtb_priv2_east = crear_route_table_privada(vpc_east, REGION_EAST, nat_east, sub2_priv_east, 'rtb_priv_vir2')
